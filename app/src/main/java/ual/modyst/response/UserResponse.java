...
public class UserResponse {
    ...
    public UserResponse(String result, int unique_id, int unique_id_roles, String full_name, String email, String password, String sex, String phone_number, String address, String registration_key, String created, String modified) {
        this.result = result;
