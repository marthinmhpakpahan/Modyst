...
import ual.modyst.R;
import ual.modyst.adapter.RequestAdapter;
...
public class RequestsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initalizeComponent(){
        ...
        requestAdapter = new RequestAdapter(RequestsActivity.this, requestsList);
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private RequestsActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final RequestsActivity.ClickListener clickListener) {
