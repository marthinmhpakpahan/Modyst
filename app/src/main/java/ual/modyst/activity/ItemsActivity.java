...
import ual.modyst.R;
import ual.modyst.adapter.ItemAdapter;
...
public class ItemsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initalizeComponent(){
        ...
        itemAdapter = new ItemAdapter(ItemsActivity.this, itemsList);
    ...
    public void onClick(View v) {
        if(v == fab){
            Intent intent = new Intent(ItemsActivity.this, CreateItemActivity.class);
            startActivity(intent);
        }
    }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private ItemsActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ItemsActivity.ClickListener clickListener) {
