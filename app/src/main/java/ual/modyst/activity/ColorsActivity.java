...
import ual.modyst.R;
import ual.modyst.adapter.ColorAdapter;
...
public class ColorsActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initalizeComponent(){
        ...
        colorAdapter = new ColorAdapter(ColorsActivity.this, colorsList);
    ...
    public void onClick(View v) {
        if(v == fab){
            Intent intent = new Intent(ColorsActivity.this, CreateColorActivity.class);
            startActivity(intent);
        }
    }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private ColorsActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final ColorsActivity.ClickListener clickListener) {
