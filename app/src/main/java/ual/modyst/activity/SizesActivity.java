...
import ual.modyst.R;
import ual.modyst.adapter.SizeAdapter;
...
public class SizesActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initalizeComponent(){
        ...
        sizeAdapter = new SizeAdapter(SizesActivity.this, sizesList);
    ...
    public void onClick(View v) {
        if(v == fab){
            Intent intent = new Intent(SizesActivity.this, CreateSizeActivity.class);
            startActivity(intent);
        }
    }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private SizesActivity.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final SizesActivity.ClickListener clickListener) {
